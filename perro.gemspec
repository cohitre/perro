Gem::Specification.new do |s|
  ...
  s.files = ["History.txt", "Manifest.txt", "README.txt", "Rakefile", "lib/perro.rb", "lib/perro/haml_handler.rb", "lib/perro/proxy_handler.rb", "lib/perro/sass_handler.rb", "test/test_perro.rb"]
  s.has_rdoc = true
  ...
  if s.respond_to? :specification_version then
    ...
    if current_version >= 3 then
      ...
      s.add_runtime_dependency(%q<haml>, [">= 2.0.2"])
      s.add_development_dependency(%q<hoe>, [">= 1.7.0"])
    else
      s.add_dependency(%q<mongrel>, [">= 1.1.4"])
      s.add_dependency(%q<haml>, [">= 2.0.2"])
