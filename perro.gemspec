Gem::Specification.new do |s|
  ...
  s.files = ["History.txt", "Manifest.txt", "README.txt", "Rakefile", "assets/index.haml", "assets/server.rb", "assets/javascripts/jquery.js", "assets/javascripts/qunit.js", "assets/stylesheets/qunit.css", "assets/stylesheets/reset.css", "bin/perro", "lib/perro.rb", "lib/perro/route.rb", "test/test_perro.rb"]
  s.has_rdoc = true
